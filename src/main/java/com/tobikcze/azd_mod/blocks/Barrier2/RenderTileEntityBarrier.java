package com.tobikcze.azd_mod.blocks.Barrier2;

import com.tobikcze.azd_mod.blocks.Barrier2.TileEntityBarrier;
...
public class RenderTileEntityBarrier extends TileEntitySpecialRenderer {
    ...
    public RenderTileEntityBarrier() {
        ...
        objModelLocation = new ResourceLocation("azd", "models/Barrier_2.obj");
