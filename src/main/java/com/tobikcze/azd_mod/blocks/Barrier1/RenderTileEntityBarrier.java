...
import com.tobikcze.azd_mod.blocks.Barrier1.TileEntityBarrier;
...
public class RenderTileEntityBarrier extends TileEntitySpecialRenderer {
    ...
    public RenderTileEntityBarrier() {
        ...
        objModelLocation = new ResourceLocation("azd", "models/Barrier_1.obj");
    ...
    public void renderTileEntityAt(TileEntity te, double posX, double posY, double posZ, float timeSinceLastTick) {
        ...
        bindTexture(texture);
        GL11.glPushMatrix();
        GL11.glTranslated(posX + 0.5, posY + 0.1, posZ + 0.5 - 0.2);
        GL11.glPushMatrix();
